...
const Paises = () =>{
    ...
    return(
        <div>
            <input type="text" placeholder="Buscar Pais por el nombre..."
                    ...
                    {paisesFiltrados.map((pais)=>(
                        <details>
                            <summary>
                                ...
                                width={40} style={{marginRight:"10px"}} 
                                />
                                <span>{pais.name.common}</span>
                                </li>
                            </summary>
                            <li>Capital: {pais.capital}</li>
                            <li>Poblacion: {pais.population}</li>
                            <a href={pais.maps.googleMaps}><li>Mapa en Google</li></a>
                        </details>
                    ))}
                </ul>
            )}
